...
#import "LoginIboardViewController.h"
...
@interface LoginIboardViewController ()
{
    CGSize  windowSize;
}
...
@implementation LoginIboardViewController
...
-(void)callWebView:(UIButton*)sender{
    if ([SingletonClassIboard shareSinglton].isActivenetworkConnection==NO) {
        ...
        WebViewViewControllerIboard *  webviewVC=[[WebViewViewControllerIboard alloc]initWithNibName:@"WebViewViewControllerIboard" bundle:nil];
...
-(void)loginCheckComplete
{
    ...
    CustomMenuViewControllerIboard * mainMenu=[LoginIboardViewController goTOHomeView];
