...
@interface CustomMenuViewControllerIboard : UIViewController<UITableViewDataSource, UITableViewDelegate, UITabBarDelegate> {
...
@interface UIViewController (CustomMenuViewControllerIboardItem)

@property (nonatomic, strong) CustomMenuViewControllerIboard *CustomMenuViewControllerIboard;
//-(CustomMenuViewControllerIboard *)firstAvailableViewController;
