...
@interface ProfileViewController ()
{
    ...
    CustomMenuViewControllerIboard * customMenu;
...
-(void)createUIForProfile{
    ...
    [self.view addSubview:profile_pic];
     ...
     NSLog(@"%@",[SingletonClassIboard shareSinglton].user_full_name);
    if (full_name) {
        full_name=nil;
    }
    full_name =[[UILabel alloc]init];
    full_name.frame=CGRectMake(80, 30, 150,20);
    full_name.text=[SingletonClassIboard shareSinglton].user_full_name;
    full_name.font=[UIFont boldSystemFontOfSize:12];
    full_name.textColor=[UIColor whiteColor];
    [self.view addSubview:full_name];
    
     NSLog(@"%@",[SingletonClassIboard shareSinglton].user_name);
    if (username) {
        username=nil;
    }
    username=[[UILabel alloc]init];
    username.frame=CGRectMake(80, 60, 150, 10);
    username.text=[SingletonClassIboard shareSinglton].user_name;
    ...
    //-------------------
    NSString * media=[self abbreviateNumber:[[SingletonClassIboard shareSinglton].followed_by intValue]];
    ...
    NSString * follws=[self abbreviateNumber:[[SingletonClassIboard shareSinglton].follows intValue]];
    ...
    NSString * follwing=[self abbreviateNumber:[[SingletonClassIboard shareSinglton].medaiCnt intValue]];
...
-(void)getDataForProfile : (NSString *)accessToken{
    [SingletonClassIboard shareSinglton].user_full_name=@" ";
    [SingletonClassIboard shareSinglton].user_pic=@" ";
    [SingletonClassIboard shareSinglton].userID=@" ";
    
    NSMutableDictionary * dict=[NSMutableDictionary dictionary];
    
    
    for (int i=0; i<[SingletonClassIboard shareSinglton].allData.count;i++) {
        dict=[[SingletonClassIboard shareSinglton].allData objectAtIndex:i];
        if ([accessToken isEqualToString:[dict objectForKey:@"accessToken"]]) {
            [SingletonClassIboard shareSinglton].user_full_name=[dict objectForKey:@"userFullName"];
            [SingletonClassIboard shareSinglton].user_pic=[dict objectForKey:@"profilePic"];
            //[SingletonClassIboard shareSinglton].user_name=[dict objectForKey:@"username"];
            [SingletonClassIboard shareSinglton].userID=[dict objectForKey:@"userId"];
            [SingletonClassIboard shareSinglton].medaiCnt=[dict objectForKey:@"mediaCnt"];
            [SingletonClassIboard shareSinglton].followed_by=[dict objectForKey:@"following"];
            [SingletonClassIboard shareSinglton].follows=[dict objectForKey:@"followers"];
        }
    }
