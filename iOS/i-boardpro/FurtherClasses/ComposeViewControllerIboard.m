...
@interface ComposeViewControllerIboard ()
{
...
@implementation ComposeViewControllerIboard
...
- (void)viewDidLoad {
    ...
    [SingletonClassIboard shareSinglton].notfyArr=[[NSMutableArray alloc]init];
...
-(void)postButtonAction{
    ...
    NSDictionary *userDict = [NSDictionary dictionaryWithObjectsAndKeys:unix_time, @"unixTime", access_token, @"access_token",composeText,@"caption", nil];
    NSLog(@"%@ dictionary",userDict);
    [[SingletonClassIboard shareSinglton].notfyArr addObject:userDict];
