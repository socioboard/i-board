...
public class InstagramApp {
	...
	public InstagramApp(Context context, String clientId, String clientSecret,
		...
		mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
				+ mCallbackUrl + "&response_type=code&display=touch&scope=likes+comments+relationships+basic";
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String profilepic=jsonObj.getJSONObject("user").getString("profile_picture");
					
					mSession.storeAccessToken(mAccessToken, id, user, name,profilepic);
	...
	private void fetchUserName() {
		...
		System.out.println("id========="+ mSession.getId());
		new Thread() {
			@Override
			public void run() {
