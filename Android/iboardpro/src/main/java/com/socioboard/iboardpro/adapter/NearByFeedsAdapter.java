...
import com.socioboard.iboardpro.fragments.NearByFeed_Fragment;
...
public class NearByFeedsAdapter extends BaseAdapter {
	...
	public NearByFeedsAdapter(Context context, ArrayList<FeedsModel> arrayList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.nearbyfeedsitem, parent,
					false);
		}
	...
	public class follow_task extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			 ...
			 * mSpinner.show();
			 */
			NearByFeed_Fragment.user_feeds_list.remove(selected_position);
			NearByFeed_Fragment.adapter.notifyDataSetChanged();
