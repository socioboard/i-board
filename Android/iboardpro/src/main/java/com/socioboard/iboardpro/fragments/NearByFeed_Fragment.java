...
import com.socioboard.iboardpro.adapter.NearByFeedsAdapter;
 ...
 * view
 */
public class NearByFeed_Fragment extends Fragment implements OnScrollListener {
	...
	public static NearByFeedsAdapter adapter;
	ViewGroup viewGroup;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (detector.isConnectingToInternet()) {
			FetchFeeds(MainSingleTon.selected_location_id);
		} else {
			Toast.makeText(getActivity(), "Please connect to internet!",
					Toast.LENGTH_LONG).show();
		}

		feedlistview.setOnScrollListener(NearByFeed_Fragment.this);
	...
	private void FetchFeeds(String keywords) {
		...
		String url = ConstantUrl.URL_Location_media + keywords
				...
				null, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject json) {
						...
						try {
							...
							System.out.println("nearBymediaFeeds"
									+ json.toString());
	...
	void setAdapter() {
		adapter = new NearByFeedsAdapter(getActivity(), user_feeds_list);
