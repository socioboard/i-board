...
import com.socioboard.iboardpro.SplashActivity;
import com.socioboard.iboardpro.WelcomeActivity;
...
public class AccountAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		profilePic.setImageBitmap(utilss.getBitmapFromString(navDrawerItems
				.get(position).getUserimage()));
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								if (navDrawerItems.size() > 1) {
									...
									dbdata.deleteThisUserData(navDrawerItems
									...
									Editor editor = context.getSharedPreferences("iboardpro",
